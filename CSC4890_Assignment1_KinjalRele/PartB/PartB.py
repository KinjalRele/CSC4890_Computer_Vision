...
import CalibratingPartB
rvecs = CalibratingPartB.rvecs
tvecs = CalibratingPartB.tvecs
...
intrinsic_matx = np.append( np.append(CalibratingPartB.mtx, [[0],[0],[1]], axis=1), [np.array([0,0,0,1])], axis=0)

print(CalibratingPartB.mtx)
